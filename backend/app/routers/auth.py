...
from app.schemas.auth import (
    ApiKeyCreate, ApiKeyListItem, ApiKeyResponse,
    LoginRequest, RegisterRequest, TokenResponse, UserResponse,
)
from app.services.auth_service import (
    authenticate_user, create_access_token, create_api_key,
    create_user, get_user_by_email, list_api_keys, revoke_api_key,
)
...
async def create_key(
    ...
    key = await create_api_key(db, current_user.id, data.name)
